...
export const updateUser = async(req,res) =>{
    try {
        ...
        //since they are array
        if(skills){
            if(skills.image1){
                // if suppose js excist and you want to change it so first destoy the first one upload it then use it
        ...
        if(about){
            ...
            // to avoid that if avatar is update and other details also get remeoved placing them inside if
            if(about.name){     
...
export const addTimeline = async(req,res) =>{
    try {
        ...
        //since we are pushing it at the last and display at the top
